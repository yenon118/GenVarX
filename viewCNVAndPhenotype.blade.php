...
<body>
    ...
    @endphp
    <button onclick="queryCNVAndPhenotype('{{$organism}}')" style="margin-right:20px; background-color:#99DDFF;">View Data</button>
    <button onclick="downloadCNVAndPhenotype('{{$organism}}')" style="margin-right:20px; background-color:#FFFFFF;">Download Data</button>
    </div>
    <br/><br/>
