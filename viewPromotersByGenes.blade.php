...
function getMotifWeblogo(organism, motif, gene, chromosome, motif_start, motif_end, motif_sequence) {
    ...
    if (organism === "Osativa") {
        weblogo.setAttribute("src", "{{ asset('system/home/GenVarX/assets/mViz_Rice_Japonica_motif_weblogos')}}" + "/" + motif + ".png");
        document.getElementById(gene+"_weblogo").appendChild(weblogo);
    } else if(organism === "Athaliana") {
        weblogo.setAttribute("src", "{{ asset('system/home/GenVarX/assets/mViz_Arabidopsis_motif_weblogos')}}" + "/" + motif + ".png");
        document.getElementById(gene+"_weblogo").appendChild(weblogo);
    } else if(organism === "Zmays") {
        weblogo.setAttribute("src", "{{ asset('system/home/GenVarX/assets/mViz_Maize_motif_weblogos') }}" + "/" + motif + ".png");
        document.getElementById(gene+"_weblogo").appendChild(weblogo);
    }
